            ...
            <div className="mt-8 sm:mt-14 w-full max-w-4xl mx-auto">
              <form 
                onSubmit={(e) => {
                  ...
                  // AI mode is now the global default, so we always navigate to /assistant
              ...
              >
                ...
                <div className="relative">
                  <input 
                    ...
                    placeholder={searchMode === "ai" ? "Ask anything, e.g. I want to report a lost car" : "Search services..."} 
                    className="w-full p-6 sm:p-8 pr-16 sm:pr-20 rounded-2xl sm:rounded-[2.5rem] bg-white/10 backdrop-blur-3xl border border-white/20 text-white placeholder-white/40 focus:outline-none focus:ring-4 focus:ring-emerald-500/30 shadow-2xl transition-all h-20 sm:h-24 text-base sm:text-xl font-medium"
                  />
                  <Button 
                    type="submit" 
